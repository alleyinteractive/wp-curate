...
final class Block_Offset extends Block_Validator {
	 ...
	 *
	 * @phpstan-var array{blocks: WP_Block_Parser_Block[], offset: int|int[], skip_empty_blocks: bool}
	 *
	 * @var mixed[]
	 */
	protected $options = [
	 ...
	 */
	protected function setBlocks( $blocks ): void {
	 ...
	 */
	protected function setSkipEmptyBlocks( $skip ): void {
